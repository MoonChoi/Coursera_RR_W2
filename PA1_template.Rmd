---
title: "eproducible Research: Peer Assessment 1"
author: "Moon Choi"
date: '2017 1 22 '
output:
  html_document:
...
```{r, echo = TRUE}
qplot(stepsEachDay$steps, xlab="total number of steps taken each day")
```
...
qplot(modiStepsEachDay$steps, xlab="total number of steps taken each day")
